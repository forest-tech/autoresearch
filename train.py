...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, value_embedding_lr=0.2, matrix_lr=0.02,
...
VALUE_EMBEDDING_LR = 0.60 # learning rate for value embeddings (Adam)
