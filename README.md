...
This repository was originally forked from [karpathy/autoresearch](https://github.com/karpathy/autoresearch).

It has since diverged significantly and is now maintained as an independent repository, with additional infrastructure for HPC execution, parallel autonomous experiments, configurable evaluation metrics, and experiment management.
